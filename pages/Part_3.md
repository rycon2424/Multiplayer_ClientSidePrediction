...
```
<br>
Now that we are done with the clients side of data. We now need to make the server actually do something with this info. <br>
<br>
*This is basically where we are at right now, the local client has prediction for himself but the server and other players do not acknowledge any of it*
